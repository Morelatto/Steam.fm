...
public class Relacao implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        return (this.idRelacao != null || other.idRelacao == null) && (this.idRelacao == null || this.idRelacao.equals(other.idRelacao));
    }

    @Override
    public String toString() {
        return "br.com.lp3.entities.Relacao[ idRelacao=" + idRelacao + " ]";
    }
