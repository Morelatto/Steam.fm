...
public class Musica implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        return (this.idMusica != null || other.idMusica == null) && (this.idMusica == null || this.idMusica.equals(other.idMusica));
    }

    @Override
    public String toString() {
        return "br.com.lp3.entities.Musica[ idMusica=" + idMusica + " ]";
    }
