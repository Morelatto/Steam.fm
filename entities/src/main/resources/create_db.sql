...
-- TODO update table and field names
...
INSERT INTO GAME_GENDER (gender_name) VALUES
('2D'),
('Ação'),
('Ação / Aventura'),
('Anime'),
...
INSERT INTO MUSICA (TITULO_MUSICA, ID_MUSICA_LASTFM) VALUES
...
INSERT INTO ALBUM (TITULO_ALBUM, ID_ALBUM_LASTFM) VALUES 
...
INSERT INTO ARTISTA (NOME_ARTISTA, ID_ARTISTA_LASTFM) VALUES 
...
ID_GENERO_JOGO INT, FOREIGN KEY (ID_GENERO_JOGO) REFERENCES GAME_GENDER (id) ON DELETE CASCADE,
ID_MUSICA INT, FOREIGN KEY (ID_MUSICA) REFERENCES MUSICA (ID_MUSICA) ON DELETE CASCADE,
ID_ALBUM INT, FOREIGN KEY (ID_ALBUM) REFERENCES ALBUM (ID_ALBUM) ON DELETE CASCADE,
ID_ARTISTA INT, FOREIGN KEY (ID_ARTISTA) REFERENCES ARTISTA (ID_ARTISTA) ON DELETE CASCADE
);

INSERT INTO RELACAO(ID_GENERO_JOGO, ID_MUSICA, ID_ALBUM, ID_ARTISTA) VALUES
...
INSERT INTO USUARIO(LOGIN, SENHA, USUARIO_STEAM) VALUES ('admin', 'admin', null);

--SELECT musicReleaseAndGameMap.id_relacao, genero_jogo.nome_genero, music.titulo_musica, album.titulo_album, artist.nome_artista FROM   musicReleaseAndGameMap LEFT JOIN genero_jogo ON genero_jogo.id_genero_jogo = musicReleaseAndGameMap.id_genero_jogo LEFT JOIN music ON music.id_musica = musicReleaseAndGameMap.id_musica LEFT JOIN album ON album.id_album = musicReleaseAndGameMap.id_album LEFT JOIN artist ON artist.id_artista = musicReleaseAndGameMap.id_artista;