...
function UserReview_Rate( recommendationID, bRateUp, baseURL, callback )
{
	$J.post( baseURL + '/userreviews/rate/' + recommendationID,{
		...
		{
			ShowAlertDialog( 'Erro', 'Você precisa iniciar a sessão para realizar essa ação.' );
		}
		...
		{
			ShowAlertDialog( 'Erro', 'A sua conta não atende aos requisitos para usar este recurso. <a class="whiteLink" href="https://support.steampowered.com/kb_article.php?ref=3330-IAGK-7663" target="_blank">Acesse o Suporte Steam</a> para mais informações.' );
		}
		else
		{
			ShowAlertDialog( 'Erro', 'Houve um erro ao processar o seu pedido:' + results.success );
		}
	} );
}
...
function UserReview_Report( recommendationID, baseURL, callback )
{
	...
	explanation.html( 'Por favor, insira o motivo da denúncia desta análise por violação dos Termos de Serviço ou Regras de Conduta Online do Steam. Isso não pode ser desfeito.' );
...
{
	var dialog = ShowPromptWithTextAreaDialog( 'Responder', recommendation.developer_response, null, null, 8000 );
	var explanation = $J('<div/>', { 'class': 'user_review_report_dialog_explanation' } );
